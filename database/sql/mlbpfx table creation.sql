DROP TABLE IF EXISTS pfx_pitches;

CREATE TABLE pfx_pitches(
  ...
  ,pfx_pitches_id int auto_increment primary key,
  unique key (game_id, sv_id)
);

DROP TABLE IF EXISTS pfx_atbats;

CREATE TABLE pfx_atbats(
  ...
  ,pfx_atbats_id int auto_increment primary key
  ,unique key (game_id,ab_number)
);

load data local infile "/Users/dangoldberg/pitch_table2017-02-18_2015-04-05_2015-04-30.csv" into table pfx_pitches
columns terminated by ',' enclosed by '"' IGNORE 1 LINES;

load data local infile "/Users/dangoldberg/atbat_table2017-02-18_2015-04-05_2015-04-30.csv" into table pfx_atbats
columns terminated by ',' enclosed by '"' IGNORE 1 LINES;

select * from pfx_pitches limit 100;

select * from pfx_atbats limit 100;
